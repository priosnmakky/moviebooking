...
<div class="table">
    ...
    <table  align="center" >
    <tr><td colspan="2"> <h1>up Customer </h1></td></tr>
        <form:form  method="post" action="/MoviesBooking/Customer/addValidCustomerup" commandName="customer" enctype="multipart/form-data">
            <form:hidden path="id"/>
